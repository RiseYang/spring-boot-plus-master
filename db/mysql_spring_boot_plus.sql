...
(
    ...
    order_status  tinyint(0)     NOT NULL DEFAULT 1 COMMENT '订单状态 1：待支付，2：已支付，3：已发货，4：已完成，5：已取消',
    ...
    PRIMARY KEY (id) USING BTREE,
    UNIQUE INDEX sys_order_order_no_uindex (order_no) USING BTREE,
    INDEX sys_order_order_status_index (order_status) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '系统订单'
  ROW_FORMAT = Dynamic;
